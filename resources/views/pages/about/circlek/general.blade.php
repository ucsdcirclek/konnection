    ...
    <div id="main">
        ...
        <h5>Service</h5>
          <p>UCSD Circle K holds multiple weekly service events and you do not
             ...
             kitchens, to helping children at Boys and Girls Club. Rides are
        ...
        <h5>Leadership</h5>
          <p>UCSD Circle K has a multitude of leadership opportunities.
            ...
            input. Furthermore, every event requires a chair, a responsibility
            that anyone may request. Lastly, our club has an Elected Board
            which is chosen by club members every year before Spring Quarter
        ...
        <h5>Fellowship</h5>
          <p>UCSD Circle K provides an abundance of social and friendship
            ...
            out for a meal at local San Diego restaurants, to having a board
            game night in the UCSD library. Circle K also has an awesome family
             system that enables more intimate friendships and a great
             mentorship program in which returning members guide new members
        ...
        <p>I pledge to uphold the Objects of Circle K International, to foster
          ...
          DEDICATE MYSELF TO THE REALIZATION OF MANKIND'S POTENTIAL!</b></p>
